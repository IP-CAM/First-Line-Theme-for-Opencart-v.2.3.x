			...
			<div class="<?=$class?>">
				<div class="content">
					...
					<div id="content">
						...
						<?php if ($categories) { ?>
						<div class="row">
								<ul class="list-inline category-list hidden-xs">
									<?php foreach ($categories as $category) { ?>
									<li class="category-list-item"><a href="<?php echo $category['href']; ?>"><?php echo $category['name']; ?></a></li>
									<?php } ?>
								</ul>
						</div>
						<?php } ?>
						...
						<div class="buttons">
							<div><a href="<?php echo $continue; ?>" class="btn mybtn btn-primary btn-no-products"><?php echo $button_continue; ?></a></div>
						</div>
						<?php } ?>
					</div>
				</div>
